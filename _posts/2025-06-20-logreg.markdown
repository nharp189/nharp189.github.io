...
The function requires a meta-analytic database object (see https://github.com/canlab), a series of contrast indicator maps (i.e., brain maps with binary outcomes of activation [1] or no activation [0]), and a design matrix for which the function will generate statistical estimates. 
